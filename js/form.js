...
var mod = 0;
var q1, q2;
var pkg_MET = new Config(), pkg_IMP = new Config(), case_MET = new Config(), case_IMP = new Config();
...
function convertToMetric(val) {
    return roundToNearest(val * IMP_IMP);
}
...
// On button clicked: change appeared modifier values
// i) +1.5, +1.5, +2; or ii) +2, +2, +2.5
...
// This is only in Metric as the modifiers are only considered in Metric
